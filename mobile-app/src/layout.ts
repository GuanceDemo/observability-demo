...
export const STOREFRONT_SHELL_HORIZONTAL_INSET = 16;
export const MIN_TOUCH_TARGET_SIZE = 48;
export const STOREFRONT_HEADER_ACTION_SIZE = MIN_TOUCH_TARGET_SIZE;
export const FAULT_TOOLBAR_BUTTON_SIZE = STOREFRONT_HEADER_ACTION_SIZE;
