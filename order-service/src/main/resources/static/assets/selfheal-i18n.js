(function () {
  ...
  const messages = {
    zh: {
      ...
      androidFaultEntryHint: '选择 Android异常并启用场景，再到 App 操作触发；结算闪退会在 App 内确认。',
    ...
    en: {
      ...
      androidFaultEntryHint: 'Enable an Android error scenario here, then trigger it in the app. Checkout crash requires in-app confirmation.',
