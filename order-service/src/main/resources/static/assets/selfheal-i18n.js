(function () {
  ...
  const messages = {
    zh: {
      ...
      sceneAndroidTitle: '商城App Demo',
      sceneAndroidDescription: '运行于真实 Android 环境 · APK 可交互',
      sceneGameTitle: '游戏 Demo',
      sceneGameDescription: 'ORBITAL DRIFT WebGL 回放实验',
      sceneRunning: '运行中',
      ...
      androidDebugPanelTitle: '真实 APK 调试信息',
      ...
      androidFaultEntryHint: '请在 APK 顶部警告入口中选择并触发故障；Web 侧只展示连接、设备与观测调试信息。',
    ...
    en: {
      ...
      androidDebugPanelTitle: 'Real APK diagnostics',
      ...
      androidFaultEntryHint: 'Choose and trigger faults from the warning entry inside the APK. The Web panel only shows connection, device, and observability diagnostics.',
  ...
  const faultTexts = {
    ...
    game_render_overload: {
      zh: {
        ...
        observation: '点击注入后无需继续操作。在同一 game/orbital-drift View 中查看开始与恢复 Action、多段 Long Task、FPS/掉帧统计，以及持续卡顿但仍连续采集的 WebGL 画面。',
      },
      en: {
        ...
        observation: 'Click Inject and no further game action is required. In the same game/orbital-drift View, inspect the start/recovery Actions, repeated Long Tasks, FPS/drop statistics, and visibly degraded WebGL frames that continue to be captured.',
      },
    },
    game_asset_load_failure: {
      zh: {
        ...
        observation: '点击注入后无需继续操作。在同一 game/orbital-drift View 中查看两条 404 Resource、game_asset_load_failed Action、一条 handled Error、一次自动重试、恢复 Action，以及 Replay 中持续可见的占位材质。',
      },
      en: {
        ...
        observation: 'Click Inject and no further game action is required. In the same game/orbital-drift View, inspect two 404 Resources, the game_asset_load_failed Action, one handled Error, one automatic retry, the recovery Action, and the placeholder material visible throughout Replay.',
      },
    },
    order_slow: {
      zh: {
