(function () {
  ...
  const messages = {
    zh: {
      ...
      businessScenes: '业务场景',
      businessSceneCount: '{count} 个场景',
      sceneBookstoreTitle: '商城 Demo',
      sceneBookstoreDescription: '图书商城',
      sceneAndroidTitle: '商城 APP Demo',
      sceneAndroidDescription: 'Android 真机操作',
      sceneGameTitle: '游戏 Demo',
      sceneGameDescription: '小游戏合集',
      sceneRunning: '运行中',
      simulatorTitle: '业务场景模拟器',
      previewWeb: 'Web 预览',
      previewMobile: '移动端',
      previewWebOnly: '仅支持 Web',
      previewMobileOnly: '仅支持移动端',
      browserAddress: 'https://demo.dataflux.cn',
      faultConsoleTitle: '故障注入控制台',
      androidDebugConsoleTitle: '真实 APK 调试台',
      androidDebugPanelTitle: '商城 APP 故障控制',
      apkRefresh: '连接 / 刷新 APK',
      apkDiagnostics: '连接与设备参数',
      apkDisconnected: 'APK 未连接，请点击连接 / 刷新。',
      apkObservationHint: '触发故障后查看关联数据；会话回放需进入对应 View 后打开。',
      androidApkDownloadTrigger: '获取 APK',
      androidApkDownloadTitle: '安装商城 App Demo',
      androidApkDownloadDescription: '下载当前演示使用的 APK，可安装到 Android 设备或本地 Emulator。',
      androidApkDownloadClose: '关闭 APK 下载',
      androidApkDownloadQrAlt: 'APK 下载二维码',
      androidApkDownloadScanHint: '使用手机扫码下载，或在当前设备直接下载安装包。',
      androidApkDownloadMeta: 'v{version} · Android {minVersion}+',
      androidApkDownloadMetaUnknown: 'Android {minVersion}+',
      androidApkDownloadAction: '下载 APK',
      collapseScenes: '收起业务场景',
      expandScenes: '展开业务场景',
      collapseFaults: '收起故障控制台',
      expandFaults: '展开故障控制台',
      collapseDiagnostics: '收起调试台',
      expandDiagnostics: '展开调试台',
      parentTitle: '商城 Demo 与故障注入 Demo',
      parentLead: '左侧业务场景运行在独立 iframe 中，RUM 只在场景页面初始化；右侧故障注入与日志面板不采集前端 RUM。',
      parentIframeLabel: '业务场景',
      parentOpenShop: '打开独立场景',
      parentOpenScene: '打开独立场景',
      parentRumStatus: '场景 RUM',
      parentRumPending: '等待场景上报',
      ...
      faultKindLongTask: '长任务',
      faultKindRenderOverload: '渲染过载',
      faultKindResourceError: '资源错误',
      parentGameFaultEnterTitle: '进入飞机大战后可注入故障',
      parentGameFaultEnterDesc: '大厅和植物教学关暂不提供故障注入。',
      ...
      parentGameFaultActiveDetail: '{layer} / {kind}，注入后自动执行约 10 秒；完成后可再次注入。',
      ...
      androidEventHistoryTitle: 'WebRTC 连接事件',
      androidEventCount: '{count} 条事件',
      androidEventEmpty: '播放器连接、断开与链路切换会显示在这里。',
      androidEventPlayerReady: '播放器已加载',
      androidEventConnection: '连接状态变为 {state}',
      androidEventRoute: '候选链路切换为 {route}',
      androidEventError: '播放器异常',
      androidEventInfo: '信息',
      androidEventWarning: '注意',
      androidEventFailed: '异常',
      androidConnectionQuality: '连接质量',
      androidConnectionWaiting: '等待播放器',
      androidConnectionConnecting: '连接中',
      androidConnectionConnected: '已连接',
      androidConnectionWaitingInput: '输入通道准备中',
      androidConnectionWaitingFirstFrame: '正在获取首帧',
      androidConnectionRecoveringFrame: '正在刷新画面',
      androidConnectionSnapshotFallback: '真实截图 · 视频恢复中',
      androidConnectionReconnecting: '正在重连视频',
      androidConnectionUnavailable: '浏览器不支持帧检测',
      androidConnectionDisconnected: '已断开',
      androidConnectionFailed: '连接失败',
      androidCandidatePath: '候选链路：{route}',
      androidRouteDirect: '直连',
      androidRouteStun: 'STUN 直连',
      androidRouteTurn: 'TURN 中继',
      androidMetricRtt: 'RTT',
      androidMetricDataChannelRtt: '输入 RTT (SCTP)',
      androidMetricLoss: '丢包率',
      androidMetricFps: '解码 FPS',
      androidMetricBitrate: '接收码率',
      androidMetricInputToFrame: '点击→下一视频帧',
      androidMetricInputToVisualChange: '点击→首个画面变化帧',
      androidMetricInputToAppAck: '点击→APK 操作确认',
      androidMetricMeasuring: '测量中…',
      androidMetricTimeout: '> 5 秒',
      androidMetricAmbiguous: '有其他输入，未归因',
      androidInputReleaseToAck: '松开→APK 确认',
      androidVideoFrameAge: '视频帧龄',
      androidVideoFrames: '呈帧 / 解码帧',
      androidPlaybackTime: '播放时间 / 页面',
      androidVideoLatency: '视频回显 p50 / p95',
      androidSnapshotLatency: '截图回显 p50 / p95',
      androidVideoSamples: '视频样本 / 超时',
      androidSnapshotSamples: '截图样本 / 超时',
      androidMetricInputNotReady: '输入未就绪',
      androidTransportDetails: '传输与解码',
      androidIceState: 'ICE 状态',
      androidSignalingState: '信令状态',
      androidMediaReadiness: '媒体就绪',
      androidFrameRecovery: '画面恢复请求',
      androidFrameRecoveryCount: '{count} 次',
      androidInputQueueDelay: '最近输入排队',
      androidResolution: '视频分辨率',
      androidCodec: '视频编码',
      androidJitter: '抖动',
      androidJitterBufferAverage: '区间抖动缓冲',
      androidDecodeAverage: '区间单帧解码',
      androidFreezes: '冻结次数 / 总时长',
      androidDroppedFrames: '累计丢帧',
      androidInputChannels: '输入通道',
      androidRuntimeDetails: '设备与应用',
      androidDeviceUptime: '设备运行时间',
      androidGfxP50: 'gfxinfo p50',
      androidGfxP90: 'gfxinfo p90',
      androidGfxP95: 'gfxinfo p95',
      androidLastAppAckAction: '最近 APK 确认操作',
      androidDeviceOnline: '已启动',
      androidDeviceOffline: '不可用',
      androidRumSource: 'APK 原生 SDK',
      androidFaultEntryTitle: '应用内故障注入',
      androidFaultEntryHint: '可在右侧选择并注入故障，再到 APK 操作触发。Crash / ANR 仍需在 APK 内确认。',
      androidDebugUpdatedAt: '采样 {time}',
      parentTraceLinkPanel: '观测详情',
      parentObservabilityDelayHint: '数据写入平台约有 1 分钟延迟，请稍后查看。',
      ...
      parentClientFaultInjected: '前端故障已注入：{title}',
      ...
      parentClientFaultHintGame: '触发方式：注入后自动运行约 10 秒粒子风暴与 12 FPS 渲染过载；预期结果：同一 RUM View 出现开始/恢复 Action、多段 Long Task、FPS/掉帧统计与持续卡顿的 WebGL Replay。',
      parentClientFaultHintGameAsset: '触发方式：注入后自动请求缺失的护盾纹理，约 5 秒重试一次，约 10 秒后切换到内置备用材质；预期结果：同一 RUM View 出现两条 404 Resource、一条 handled Error、失败/重试/恢复 Action，以及 Replay 中持续可见的降级材质。',
      ...
      parentSceneReady: '{scene} 已就绪',
      parentShopOrderResult: '商城购买 HTTP {status}：{body}',
      parentFrontendFaultTriggered: '左侧购书操作触发前端故障：{action}',
      parentGameFaultTriggered: '游戏渲染过载已恢复：{action}，持续约 {elapsedMs}ms，实际 {actualFps} FPS，掉帧 {droppedFrames}，Long Task {cpuBursts} 次',
      parentGameAssetFaultTriggered: '资源加载失败已使用备用材质恢复：{action}，持续约 {elapsedMs}ms，请求 {attempts} 次，最后状态 HTTP {httpStatus}',
      parentShopMessageBlocked: '收到非同源商城消息，已忽略。',
      parentSceneMessageBlocked: '收到非当前同源场景的消息，已忽略。',
      shopAppLabel: '图书商城',
      shopNavLabel: '书城导航',
    ...
    en: {
      ...
      businessSceneCount: '{count} scenarios',
      sceneBookstoreTitle: 'Store Demo',
      sceneBookstoreDescription: 'Bookstore',
      sceneAndroidTitle: 'Store App Demo',
      sceneAndroidDescription: 'Interactive APK running in a real Android system',
      sceneGameTitle: 'Game Demo',
      sceneGameDescription: 'ORBITAL DRIFT WebGL Replay lab',
      ...
      previewMobileOnly: 'Mobile only',
      browserAddress: 'https://demo.dataflux.cn',
      faultConsoleTitle: 'Fault Injection Console',
      androidDebugConsoleTitle: 'Real APK Diagnostics',
      androidDebugPanelTitle: 'Mall APP fault controls',
      apkRefresh: 'Connect / refresh APK',
      apkDiagnostics: 'Connection and device parameters',
      apkDisconnected: 'APK disconnected. Connect or refresh to continue.',
      apkObservationHint: 'View correlated data after triggering a fault. Open replay from its corresponding View.',
      androidApkDownloadTrigger: 'Get APK',
      androidApkDownloadTitle: 'Install Store App Demo',
      androidApkDownloadDescription: 'Download the APK used by this demo and install it on an Android device or local Emulator.',
      androidApkDownloadClose: 'Close APK download',
      androidApkDownloadQrAlt: 'QR code for APK download',
      androidApkDownloadScanHint: 'Scan with an Android phone, or download the installation package on this device.',
      androidApkDownloadMeta: 'v{version} · Android {minVersion}+',
      androidApkDownloadMetaUnknown: 'Android {minVersion}+',
      androidApkDownloadAction: 'Download APK',
      ...
      parentLead: 'The business scene runs in an isolated iframe. RUM initializes only inside that scene; the fault controls and log panel on the right do not collect frontend RUM.',
      parentIframeLabel: 'Business scene',
      parentOpenShop: 'Open scene',
      parentOpenScene: 'Open standalone scene',
      parentRumStatus: 'Scene RUM',
      parentRumPending: 'Waiting for scene',
      ...
      faultKindLongTask: 'Long task',
      faultKindRenderOverload: 'Render overload',
      faultKindResourceError: 'Resource error',
      parentGameFaultEnterTitle: 'Open Air Battle to inject faults',
      parentGameFaultEnterDesc: 'Fault injection is unavailable in the hub and garden tutorial.',
      ...
      parentGameFaultActiveDetail: '{layer} / {kind}, runs automatically for about ten seconds after injection and can then be reproduced again.',
      ...
      androidEventHistoryTitle: 'WebRTC Connection Events',
      androidEventCount: '{count} events',
      androidEventEmpty: 'Player connections, disconnects, and route changes appear here.',
      androidEventPlayerReady: 'Player loaded',
      androidEventConnection: 'Connection changed to {state}',
      androidEventRoute: 'Candidate route changed to {route}',
      androidEventError: 'Player error',
      androidEventInfo: 'Info',
      androidEventWarning: 'Attention',
      androidEventFailed: 'Error',
      androidConnectionQuality: 'Connection Quality',
      androidConnectionWaiting: 'Waiting for player',
      androidConnectionConnecting: 'Connecting',
      androidConnectionConnected: 'Connected',
      androidConnectionWaitingInput: 'Preparing input channel',
      androidConnectionWaitingFirstFrame: 'Waiting for first frame',
      androidConnectionRecoveringFrame: 'Refreshing video frame',
      androidConnectionSnapshotFallback: 'Live screenshot · video recovering',
      androidConnectionReconnecting: 'Reconnecting video',
      androidConnectionUnavailable: 'Frame detection unsupported',
      androidConnectionDisconnected: 'Disconnected',
      androidConnectionFailed: 'Connection failed',
      androidCandidatePath: 'Candidate route: {route}',
      androidRouteDirect: 'Direct',
      androidRouteStun: 'STUN direct',
      androidRouteTurn: 'TURN relay',
      androidMetricRtt: 'RTT',
      androidMetricDataChannelRtt: 'Input RTT (SCTP)',
      androidMetricLoss: 'Packet loss',
      androidMetricFps: 'Decoded FPS',
      androidMetricBitrate: 'Receive bitrate',
      androidMetricInputToFrame: 'Click → next video frame',
      androidMetricInputToVisualChange: 'Click → first visual change',
      androidMetricInputToAppAck: 'Click → APK acknowledgement',
      androidMetricMeasuring: 'Measuring…',
      androidMetricTimeout: '> 5 s',
      androidMetricAmbiguous: 'Conflicting input',
      androidInputReleaseToAck: 'Release → APK acknowledgement',
      androidVideoFrameAge: 'Video frame age',
      androidVideoFrames: 'Presented / decoded frames',
      androidPlaybackTime: 'Playback time / visibility',
      androidVideoLatency: 'Video visual p50 / p95',
      androidSnapshotLatency: 'Snapshot visual p50 / p95',
      androidVideoSamples: 'Video samples / timeouts',
      androidSnapshotSamples: 'Snapshot samples / timeouts',
      androidMetricInputNotReady: 'Input not ready',
      androidTransportDetails: 'Transport & Decode',
      androidIceState: 'ICE state',
      androidSignalingState: 'Signaling state',
      androidMediaReadiness: 'Media readiness',
      androidFrameRecovery: 'Frame recovery requests',
      androidFrameRecoveryCount: '{count}',
      androidInputQueueDelay: 'Latest input queue delay',
      androidResolution: 'Video resolution',
      androidCodec: 'Video codec',
      androidJitter: 'Jitter',
      androidJitterBufferAverage: 'Interval jitter buffer',
      androidDecodeAverage: 'Interval decode / frame',
      androidFreezes: 'Freezes / total duration',
      androidDroppedFrames: 'Dropped frames',
      androidInputChannels: 'Input channels',
      androidRuntimeDetails: 'Device & App',
      androidDeviceUptime: 'Device uptime',
      androidGfxP50: 'gfxinfo p50',
      androidGfxP90: 'gfxinfo p90',
      androidGfxP95: 'gfxinfo p95',
      androidLastAppAckAction: 'Latest APK acknowledgement',
      androidDeviceOnline: 'Booted',
      androidDeviceOffline: 'Unavailable',
      androidRumSource: 'Native APK SDK',
      androidFaultEntryTitle: 'In-app fault injection',
      androidFaultEntryHint: 'Select and inject a fault here, then trigger it in the APK. Crash / ANR still require confirmation inside the APK.',
      androidDebugUpdatedAt: 'Sampled {time}',
      parentTraceLinkPanel: 'Observability Details',
      parentObservabilityDelayHint: 'Telemetry may take about 1 minute to appear. Please check again shortly.',
      ...
      parentClientFaultInjected: 'Frontend fault injected: {title}.',
      ...
      parentClientFaultHintGame: 'Trigger: injection automatically runs a ten-second particle storm and 12 FPS render overload. Expected: the same RUM View contains start/recovery Actions, multiple Long Tasks, FPS/drop statistics, and visibly degraded WebGL Replay.',
      parentClientFaultHintGameAsset: 'Trigger: injection automatically requests a missing shield texture, retries once after about five seconds, and switches to the built-in fallback near ten seconds. Expected: the same RUM View contains two 404 Resources, one handled Error, failure/retry/recovery Actions, and a Replay-visible degraded material.',
      ...
      parentSceneReady: '{scene} is ready',
      ...
      parentGameFaultTriggered: 'Game render overload recovered: {action}, about {elapsedMs}ms at {actualFps} FPS with {droppedFrames} dropped frames and {cpuBursts} Long Tasks',
      parentGameAssetFaultTriggered: 'Asset load failure recovered with fallback: {action}, about {elapsedMs}ms, {attempts} requests, last status HTTP {httpStatus}',
      parentShopMessageBlocked: 'Ignored a non-same-origin store message.',
      parentSceneMessageBlocked: 'Ignored a message that was not from the active same-origin scene.',
  ...
  const faultTexts = {
    ...
    game_render_overload: {
      zh: {
        title: '游戏渲染过载',
        description: '自动运行约 10 秒粒子风暴与 12 FPS 渲染负载，同时生成 RUM Action、多段 Long Task 和连续 WebGL 回放数据。',
        observation: '点击注入后无需继续操作。在同一 games/air-battle View 中查看开始与恢复 Action、多段 Long Task、FPS/掉帧统计，以及持续卡顿但仍连续采集的 WebGL 画面。',
      },
      en: {
        title: 'Game render overload',
        description: 'Automatically runs a ten-second particle storm at a 12 FPS render cadence while recording RUM Actions, multiple Long Tasks, and continuous WebGL Replay data.',
        observation: 'Click Inject and no further game action is required. In the same games/air-battle View, inspect the start/recovery Actions, repeated Long Tasks, FPS/drop statistics, and visibly degraded WebGL frames that continue to be captured.',
      },
    },
    game_asset_load_failure: {
      zh: {
        title: '资源加载失败',
        description: '自动请求缺失的飞船护盾纹理，记录真实 404 Resource 与 handled Error，并显示约 10 秒降级材质。',
        observation: '点击注入后无需继续操作。在同一 games/air-battle View 中查看两条 404 Resource、game_asset_load_failed Action、一条 handled Error、一次自动重试、恢复 Action，以及 Replay 中持续可见的占位材质。',
      },
      en: {
        title: 'Asset load failure',
        description: 'Automatically requests a missing ship-shield texture, records real 404 Resources and one handled Error, and displays a degraded material for about ten seconds.',
        observation: 'Click Inject and no further game action is required. In the same games/air-battle View, inspect two 404 Resources, the game_asset_load_failed Action, one handled Error, one automatic retry, the recovery Action, and the placeholder material visible throughout Replay.',
      },
    },
    order_slow: {
      zh: {
